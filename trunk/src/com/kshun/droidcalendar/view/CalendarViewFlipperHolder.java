...
public class CalendarViewFlipperHolder {
	...
	private void initAnimation(){
        ...
        _outToLeft.setAnimationListener(listener);
        ...
        _outToRight.setAnimationListener(listener);
	...
	void setCalendarCellEventListener(CalendarCellEventListener listener){
		_listener = listener;
	}
	...
	synchronized void onNextMonth(CalendarView view){
    	...
    	_vf.showNext();
    	if(_listener != null){
    		_listener.onNextMonth(getOppsiteCalendarView(view).getCurrentDay());
    	}
	}
	...
	synchronized void onLastMonth(CalendarView view){
    	...
    	_vf.showPrevious();
    	if(_listener != null){
    		_listener.onLastMonth(getOppsiteCalendarView(view).getCurrentDay());
    	}
	}
}